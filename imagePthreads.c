...
void *convoluteThread(void* rank){
    ...
    long pix_x = srcImage->height;
    long my_first_row = (my_rank * N) / pix_row;
    long my_last_row = ((my_rank + 1) * N) / pix_row;
    long my_first_pix = (my_rank * N) / pix_x;
    long my_last_pix = ((my_rank + 1) * N) / pix_x;
